...
test('fault metrics count retries and terminal fault classes with fixed keys', async () => {
  const surface = await loadAssessmentSurface()
  assert.deepEqual(surface.faultMetrics, { infraRetries: 0, infraFaults: 0, providerFaults: 0, authFaults: 0, usageLimitFaults: 0 })
  ...
  assert.deepEqual(surface.faultMetrics, { infraRetries: 1, infraFaults: 1, providerFaults: 1, authFaults: 1, usageLimitFaults: 0 })
})
