...
export interface RawWorkflowArgs {
  ...
  /** Adapter running the documentation audit stage. */
  auditAdapter?: string
  ...
  reviewModel?: string
  /** Model for the documentation audit stage. */
  auditModel?: string
  /** Reasoning effort for the documentation audit stage. */
  auditEffort?: string
  /** Medium-tier model for the routine triage pass. */
  triageModel?: string
  /** Reasoning effort for remediation triage. */
  triageEffort?: string
